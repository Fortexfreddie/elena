...
export class RunCodeTool implements AgentTool {
    ...
    name = 'run_code';
    description = 'Execute a block of code in a secure sandbox. Requires explicit user confirmation before running.';
        ...
        return {
            ...
            parameters: {
                ...
                properties: {
                    language: {
                        type: Type.STRING,
                        description: 'The programming language (e.g., "typescript", "julia", "python").',
