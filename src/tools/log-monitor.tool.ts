...
export class LogMonitorTool implements AgentTool {
    ...
    name = 'log_monitor';
    description = 'Read recent system logs for debugging and monitoring. Returns the last 50 lines of the error log.';
    ...
    async execute(args: Record<string, unknown>, context: AgentContext): Promise<ToolResult> {
        ...
        this.logger.log(`Executing log_monitor: reading ${lines} lines from ${logPath}`);
