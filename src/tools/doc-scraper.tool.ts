...
export class DocScraperTool implements AgentTool {
    ...
    name = 'doc_scraper';
    description = 'Extract Markdown-converted text from a URL. Use this for deep research grounding when you need to read documentation or technical blog posts.';
