...
export class ResearcherAgent extends BaseAgent {
    constructor(
        ...
        super('researcher', GEMINI_MODELS.FLASH, geminiService, executorService, personasInjector);
    }
...
**CRITICAL DEVELOPMENT RULE**: If a 'web_search' tool result indicates 'DEVELOPMENT MODE' or no data, do NOT attempt to retry the search with different queries. Inform the user that web search is currently unavailable in this environment.`;
    }
}
